...
<g style="filter:url(#filter3443)">
  <circle
     ...
     cy="%s"
     cx="%s"
     style="opacity:1;fill:#ffffff;fill-opacity:0.8627451;stroke:#000000;stroke-width:1px;" />
  <text
     y="%s"
     x="%s"
...
arrow = '''
  <path 
     style="fill:none;fill-rule:evenodd;stroke:#000000;stroke-width:2px;marker-end:url(#Arrow1Lend)"
     d="m %s,%s %s,0"
...
class Circle:
    def __init__(self, x, y, text, color):
        global circ
        self.node = circ % (y, x + 25, y + 7, x + 25, text)
